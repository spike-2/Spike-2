 ...
 */
function getServiceNotesPromise(){
...
async function getActiveServiceNotes(){
  try {
    let https_promise = getServiceNotesPromise();
...
async function getNewServiceNotes(){
  let notes = await getActiveServiceNotes();
...
module.exports = {getActiveServiceNotes, getNewServiceNotes, mockNewServiceNotes};
